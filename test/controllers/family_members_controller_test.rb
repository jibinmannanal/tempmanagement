...
class FamilyMembersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create family_member" do
    assert_difference('FamilyMember.count') do
      post family_members_url, params: { family_member: { dob: @family_member.dob, nakshatra: @family_member.nakshatra, name: @family_member.name } }
    end
  ...
  test "should update family_member" do
    patch family_member_url(@family_member), params: { family_member: { dob: @family_member.dob, nakshatra: @family_member.nakshatra, name: @family_member.name } }
